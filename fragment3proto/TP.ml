...
let _ =
  try
    ...
    (*let lexbuf = Lexing.from_channel stdin in*)
      ...
      AST.print_AST_prog Format.std_formatter ast; Format.print_newline(); flush stdout;
      ...
      output_string file_out (print_list code_List "" ) ;Format.print_newline(); flush stdout;
  with
   | Lexeur.Eof          ->  exit 0
   | Lexeur.TokenInconu 
