...
and expression_a =
    ...
    | Divi      of expression_a * expression_a * int
    | Modul     of expression_a * expression_a * int
    | T_Egale   of expression_a * expression_a * int
...
and print_AST_exp form = let open Format in function
    ...
    | Divi      (g,d,t)         -> print_binaire form "Divi" g d t
    | Modul     (g,d,t)         -> print_binaire form "Modul" g d t
    | T_Egale   (g,d,t)         -> print_binaire form "T_Egale" g d t
...
and print_expr_nb1  = function
    ...
    | Divi      (g,d,t)         -> print_expr_nb2 "DiviRe" g d
    | Modul     (g,d,t)         -> print_expr_nb2 "Modulo" g d
    | T_Egale   (g,d,t)         -> print_expr_nb2 "Equal" g d
...
and print_com = function
    ...
    | Try       (c1,i,c2,t)     -> "Continue $" ^ string_of_int ((getTaille_com c1)+3) ^ " False\n" ^ print_com c1 ^ "\nDrop\nJump " ^ string_of_int ((getTaille_com c2)+1) ^ "\nSetVar " ^ i ^ "\n" ^ print_com c2
    | Throw     (e,t)           -> print_expr_nb1 e ^ "\nThrow"
...
and print_exprS = function
    ...
    | Exps      (e,es,t)        -> print_expr_nb1 e ^ print_exprS es
...
and taille_expr_nb1 w = match w with
    ...
    | Divi      (g,d,t)         -> taille_expr_nb2 g d
    | Modul     (g,d,t)         -> taille_expr_nb2 g d
    | T_Egale   (g,d,t)         -> taille_expr_nb2 g d
...
and taille_com_nb1 c = match c with
    ...
    | Try       (c1,i,c2,t)     -> 4 + (taille_com_nb1 c1) + (taille_com_nb1 c2)
    | Throw     (e,t)           -> 1 + (taille_expr_nb1 e)
